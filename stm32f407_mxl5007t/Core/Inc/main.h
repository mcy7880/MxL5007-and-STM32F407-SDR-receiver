...
/* Exported constants --------------------------------------------------------*/
/* USER CODE BEGIN EC */
#define IF_Gain         16.95 //dB - measured IF amplifier gain for fc=4.5 MHz
#define Attenuation     -5.46 //dB - tuner's output is loaded by IF amplifier input so it obliviously tends to decrease gain (it was measured)
#define MxL_max_Gain    90.0  //dB - assumption
#define Total_Gain_max  MxL_max_Gain + IF_Gain + Attenuation
